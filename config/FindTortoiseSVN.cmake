...
IF(TortoiseSVN_EXECUTABLE)
  ...
  MACRO(TortoiseSVN_WC_INFO dir prefix)
    FILE(WRITE "${PROJECT_SOURCE_DIR}/svnrev.in" "$WCREV$")
       
    EXECUTE_PROCESS(COMMAND ${TortoiseSVN_EXECUTABLE} "." "${PROJECT_SOURCE_DIR}/svnrev.in" "${PROJECT_SOURCE_DIR}/svnrev"
    ...
    ELSE(NOT ${TortoiseSVN_info_result} EQUAL 0)
        FILE(STRINGS ${PROJECT_SOURCE_DIR}/svnrev ${prefix}_WC_REVISION)
    ENDIF(NOT ${TortoiseSVN_info_result} EQUAL 0)
    FILE(REMOVE ${PROJECT_SOURCE_DIR}/svnrev.in ${PROJECT_SOURCE_DIR}/svnrev)
